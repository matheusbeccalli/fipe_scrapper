# Data Coverage Report Tool Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Create a standalone script that generates an HTML report showing data coverage gaps in the FIPE database.

**Architecture:** Single Python script (`coverage_report.py`) that queries the database for all price records, analyzes gaps between first and last recorded month for each model year, aggregates status up through models and brands, and generates a self-contained HTML file with expandable sections using pure HTML/CSS.

**Tech Stack:** Python, SQLAlchemy (reuse existing models), pandas for data manipulation, HTML/CSS output with `<details>/<summary>` elements.

---

### Task 1: Create the script skeleton with database connection

**Files:**
- Create: `coverage_report.py`

**Step 1: Create the script with imports and database setup**
...
**Step 2: Run to verify the skeleton works**

Run: `python coverage_report.py`
Expected: Output showing "FIPE Data Coverage Report Generator" and database connection message.

**Step 3: Commit**

```bash
git add coverage_report.py
git commit -m "feat: add coverage report script skeleton"
```

---

### Task 2: Implement the data fetching query

**Files:**
- Modify: `coverage_report.py`

**Step 1: Add the function to fetch all price data**

Add this function after `get_database_connection()`:
...
**Step 2: Update main to call the function**
...
**Step 3: Run to verify data fetch works**

Run: `python coverage_report.py`
Expected: Shows count of fetched records, unique months, and brands.

**Step 4: Commit**

```bash
git add coverage_report.py
git commit -m "feat: add price data fetching query"
```

---

### Task 3: Implement gap detection logic

**Files:**
- Modify: `coverage_report.py`

**Step 1: Add helper function to generate expected months**
...
**Step 2: Add function to analyze coverage**

Add after `fetch_price_data()`:
...
**Step 3: Update main to call analysis**
...
**Step 4: Run to verify analysis works**

Run: `python coverage_report.py`
Expected: Shows analysis summary with OK/gap counts.

**Step 5: Commit**

```bash
git add coverage_report.py
git commit -m "feat: add gap detection analysis logic"
```

---

### Task 4: Implement HTML generation

**Files:**
- Modify: `coverage_report.py`

**Step 1: Add CSS styles as a constant**
...
**Step 2: Add HTML generation function**

Add after `analyze_coverage()`:
...
**Step 3: Update main to generate report**
...
**Step 4: Run to generate the report**

Run: `python coverage_report.py`
Expected: Generates `coverage_report_2026-01-08.html` file.
...
### Task 5: Add dateutil dependency and update requirements.txt

**Files:**
- Modify: `requirements.txt`

**Step 1: Check if dateutil is already in requirements**

Run: `grep -i dateutil requirements.txt || echo "Not found"`

**Step 2: Add python-dateutil if missing**
...
git commit -m "chore: add python-dateutil dependency for coverage report"
```

---

### Task 6: Update CLAUDE.md with new script documentation

**Files:**
- Modify: `CLAUDE.md`

**Step 1: Add documentation for the new script**

Add a new section under "### Data Export and Analysis":
...
```bash
git add CLAUDE.md
git commit -m "docs: add coverage report script to CLAUDE.md"
```
...
**Step 2: Open the generated HTML file in browser**

Verify:
- Summary statistics show at top
- Brands are expandable
- Models within brands are expandable
- Model years show OK/Missing status
- Missing months are expandable for model years with gaps
- Colors are correct (green for OK, red for gaps)

**Step 3: Final commit if any adjustments needed**

```bash
git add -A
git commit -m "feat: complete data coverage report tool"
```
